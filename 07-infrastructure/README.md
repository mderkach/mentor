...
- отдельные папки по инструментам или типам инструментов: `package-manager`, `vcs`, `vite`, `ci`, `workspaces-monorepo`, `delivery` и т.д.
...
- Если слабо понимаешь `package.json`, scripts, что такое VCS и как выглядит базовый Git-цикл, начни с нулевого блока и стажерского слоя.
...
- [7.2 История изменений, VCS и инженерная дисциплина](./10-intern/core/7.2-история-изменений-и-инженерная-дисциплина.md)
...
- [7.2 VCS / Git: базовый цикл изменений](./10-intern/vcs/7.2-vcs-git-базовый-цикл-изменений.md)
- [7.3 VCS / Git: ветвление, merge, rebase и cherry-pick](./20-junior/vcs/7.3-vcs-git-ветвление-merge-rebase-и-cherry-pick.md)
...
| Стажер | Читать `package.json`, понимать что такое VCS, держать базовый Git-цикл и настраивать репозиторий без слепого копипаста конфигов. |
| Junior | Объяснять ветвление, merge/rebase/cherry-pick, цепочку сборки, управление зависимостями и обязательные проверки без привязки к одному инструменту. |
